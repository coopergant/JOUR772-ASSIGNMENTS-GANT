...
In the space below, write the name from the first row of the "name" column. **Answer:** Michelle Morrison
...
Describe what you think each line of this code is doing below, based on the result: showing how many registered students there have been for each course.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: It organized the count_classes in descending order from the top down.**
...
**Answer: it organized the courses by term then in alphabetical order by department.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: adds up all the seats in each term THEN organized by seat totals in descending order.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: added mean and median seats**
...
**Answer;** It now categorizes the data into different subgroups depending on the department, clumping every bit of data into the different majors. It then organizes the data in descending order of total amount of seats.
...
1.  Is the median amount of seats in communication and engineering smaller because they lack people to fill (so the college limits them) or because they are just more specialized and generally have people on specific pathways?

2.  How many of the Business and Management school's amount of seats come from 100/200 level courses? Are there massive cohorts that stick together all four years, or do they split off junior and senior year?

3.  How many of these students in the largest blocks (Business and Management, Comp Sci) are full-time majors? Are a bunch of people taking the courses for their degree's minor? Or are there this many full-time students in the biggest programs? That would present a great opportunity for other less-filled programs to grow from, if the minors are super helpful to people pursuing an adjacent degree!
