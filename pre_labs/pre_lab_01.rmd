...
What does it return? Type your answer below: [1] 4
...
In the space below, write the name of the business from the first row of the "name" column. **Answer:** Michelle Morrison
...
**Answer: it organized the courses in alphabetical order by course title.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: it organized the class by total amount of seats**
...
**Answer;** It now categorizes the data into different subgroups depending on the department, clumping every bit of data into the different majors. It then organizes the data in descending order of median seats.
...
3.  How many of these students in the largest blocks (Business and Management, Comp Sci) full-time majors? Are a bunch of people taking the course for their degree's minor?
